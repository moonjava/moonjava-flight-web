    ...
    <div class="container">
      ...
      <div class="row">
        <div class="panel">
          ...
          <form id="form" action="/moonjava-flight-web/base/voo/update" method="POST" style="margin-top: 10px;" class="form-horizontal">
            <div id="content"></div>
          </form>
...
<script type="text/javascript">
  ...
  window.addEvent('domready', function() {
    new Request.HTML({
      method : 'get',
      url : '/moonjava-flight-web/base/voo/update',
      data : params,
